...
const {
  ...
  recordPayment,              previewPayment,             getInvoicePaymentHistory, getInvoicesByUnitNumber  // Phase 4
...
router.get("/invoices/search/by-unit",       protect, getInvoicesByUnitNumber);
